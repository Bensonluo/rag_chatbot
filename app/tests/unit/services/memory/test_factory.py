...
class TestMemoryFactory:
    ...
    def test_create_sliding_window(self):
        ...
        memory = MemoryFactory.create(
            memory_type="sliding_window", message_repo=mock_repo, window_size=15
        )
    ...
    def test_create_invalid_memory_type(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            MemoryFactory.create(memory_type="invalid_type", message_repo=mock_repo)
    ...
    def test_create_sliding_window_defaults(self):
        ...
        # Act
        memory = MemoryFactory.create(memory_type="sliding_window", message_repo=mock_repo)
    ...
    def test_create_summarization_with_defaults(self):
        ...
        # Act
        memory = MemoryFactory.create(
            memory_type="summarization", message_repo=mock_repo, llm_service=mock_llm
        )
    ...
    def test_create_hybrid_with_defaults(self):
        ...
        # Act
        memory = MemoryFactory.create(
            memory_type="hybrid", message_repo=mock_repo, llm_service=mock_llm
        )
